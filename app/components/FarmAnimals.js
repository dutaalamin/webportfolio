...
export default function FarmAnimals({ className = '', style }) {
  return (
    <div className={`hidden z-5 lg:block absolute bottom-[185px] left-0 w-full pointer-events-none ${className}`} style={style}>
      {/* Cow */}
      ...
      {/* Pikachu */}
      <div className="absolute bottom-[5px] animate-run-fast" style={{ animationDelay: '3s' }}>
        <Image src="/images/pikachu.gif" alt="Pikachu" width={65} height={65} className="object-contain" />
      </div>
      {/* Psyduck */}
      <div className="absolute bottom-[5px] animate-run-slow" style={{ animationDelay: '7s' }}>
        <Image src="/images/psyduck.gif" alt="Psyduck" width={75} height={75} className="object-contain" />
      </div>
      {/* Bulbasaur */}
      <div className="absolute bottom-[5px] animate-run-rev" style={{ animationDelay: '5s' }}>
        <Image src="/images/bulbasaur.gif" alt="Bulbasaur" width={70} height={70} className="object-contain" />
      </div>
      {/* Togepi */}
      <div className="absolute bottom-[5px] animate-run" style={{ animationDelay: '6s' }}>
