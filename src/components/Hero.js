      ...
      >
        <div className="hero-container" style={{ width: '100%' }}>
          <div className="hero-content" style={{ width: '100%' }}>
            ...
            >
              <span className="badge-open">Open to ERP Functional / SAP roles</span>
        ...
        <div className="cat-container">
          <img src="https://media.tenor.com/cb9L14uH-YAAAAAM/cool-fun.gif" alt="Cat" className="cat-image" />
        </div>
      </section>

      {/* About Section */}
      <section id="about" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 1.25rem 4rem' }}>
        <h2 style={{ fontSize: '2.25rem', fontWeight: 700, color: '#fff' }}>About</h2>
        <p
          style={{
            marginTop: '1rem',
            fontSize: '1.05rem',
        ...
        >
          I’m a Software Engineer specializing in ERP development for construction projects. I’ve built RAP budgeting, MTO,
          PR→PO, and cost control modules that connect engineering and commercial teams. I’m expanding into ERP Functional /
          SAP — combining technical depth with process design to help companies automate, cut cycle times, and make faster
          decisions.
        </p>
